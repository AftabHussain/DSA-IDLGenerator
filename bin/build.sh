...
linux-ubuntu-14*)
  DEPENDENCIES+=" clang-3.8 llvm-3.8 libz-dev libedit-dev"
  ;;
...
then
  ...
  linux-ubuntu-14*)
    ...
    sudo update-alternatives --install /usr/bin/clang clang /usr/bin/clang-3.8 30
    sudo update-alternatives --install /usr/bin/clang++ clang++ /usr/bin/clang++-3.8 30
    sudo update-alternatives --install /usr/bin/llvm-config llvm-config /usr/bin/llvm-config-3.8 30
    sudo update-alternatives --install /usr/bin/llvm-link llvm-link /usr/bin/llvm-link-3.8 30
    sudo update-alternatives --install /usr/bin/llvm-dis llvm-dis /usr/bin/llvm-dis-3.8 30
    ;;
